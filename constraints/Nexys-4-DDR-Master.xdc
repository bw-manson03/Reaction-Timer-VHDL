...
set_property -dict {PACKAGE_PIN R10 IOSTANDARD LVCMOS33} [get_ports {CA[6]}]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {CA[5]}]
...
set_property LOC M17 [get_cells BTNR_IBUF_inst]
